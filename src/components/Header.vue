  ...
  <v-container>
    <v-toolbar flat class="mainHeader">
      <img src="../assets/logo.png" height='70' width="70">
        <router-link to="/"><v-toolbar-title>TOUR GUIDE</v-toolbar-title></router-link>
      
      <v-spacer></v-spacer>
      <v-toolbar-items class="hidden-xs-only">
        <v-btn text><router-link to="/">Home</router-link></v-btn>
        <v-btn text><router-link to="/tours">Tours</router-link></v-btn>
      ...
      <div class="hidden-sm-and-up">
        <v-menu offset-y>
          ...
          <v-list class="responsiveMenu">
            ...
            <v-list-item>
              <v-list-item-title><router-link to="/tours">Tours</router-link></v-list-item-title>
            </v-list-item>
            <v-list-item>
